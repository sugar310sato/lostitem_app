...
class SettingsView(ft.UserControl):
    ...
    def show_add_storage_place_dialog(self, callback):
        """保管場所追加ダイアログ"""
        place_name = ft.TextField(label="保管場所名", width=300, hint_text="例: 貴重品置き場")
    ...
    def show_edit_storage_place_dialog(self, place_name, callback):
        """保管場所編集ダイアログ"""
        new_name = ft.TextField(label="保管場所名", value=place_name, width=300)
        error_text = ft.Text("", color=ft.colors.RED)
    ...
    def show_add_find_place_dialog(self, callback):
        """拾得場所追加ダイアログ"""
        place_name = ft.TextField(label="拾得場所名", width=300, hint_text="例: 2階 トイレ前")
        error_text = ft.Text("", color=ft.colors.RED)
    ...
    def show_edit_find_place_dialog(self, place_name, callback):
        """拾得場所編集ダイアログ"""
        new_name = ft.TextField(label="拾得場所名", value=place_name, width=300)
        error_text = ft.Text("", color=ft.colors.RED)
    ...
    def show_add_staff_dialog(self, callback):
        """担当者追加ダイアログ"""
        staff_name = ft.TextField(label="担当者名（フルネーム）", width=300, hint_text="例: 田中太郎")
        error_text = ft.Text("", color=ft.colors.RED)
    ...
    def show_edit_staff_dialog(self, staff_name, callback):
        """担当者編集ダイアログ"""
        new_name = ft.TextField(label="担当者名（フルネーム）", value=staff_name, width=300)
        error_text = ft.Text("", color=ft.colors.RED)
